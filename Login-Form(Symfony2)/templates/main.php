    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    <a href="<?=$request->createUrl('user', 'logout')?>">Logout</a>
                </li>
            </ul>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li <?php echo $request->isActive('contact') ? 'class="active"' : '';?> >
                        <a href="<?=$request->createUrl('contact', 'index')?>"> Contacts</a>
                    </li>
                    <li <?php echo $request->isActive('user') ? 'class="active"' : '';?>>
                        <a href="<?=$request->createUrl('user', 'index')?>"> My Details</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
